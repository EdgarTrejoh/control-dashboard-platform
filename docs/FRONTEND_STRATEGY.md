...
- El frontend evolucionará como una plataforma de tablero de control reutilizable, no limitada al caso INFONAVIT. INFONAVIT será el primer módulo/caso de uso conectado, manteniendo una arquitectura preparada para integrar otros motores analíticos como indicadores económicos, reportes financieros y futuros módulos de inteligencia de negocio.
...
El proyecto debe enfocarse en consumo, visualizacion, exportacion y control de acceso minimo en una primera fase (consumo y generación de reportes de crédito a la vivienda --INFONAVIT-).
...
- Modificar datos.
- Consulta a otras fuentes de información. 
...
El diseno debe permitir evolucionar hacia:
...
Puede iniciarse con una autenticacion simple, pero no debe publicarse sin control de acceso.
...
- Crear repo `control_dashboard_platform`.
